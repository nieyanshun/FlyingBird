package org.flying.bird.rpc.javassist;
...
public class ProxyGenerator {
    ...
    private static ConcurrentHashMap<Class<?>, Object> proxyInstanceCache =
    ...
    public static Object newProxyInstance(ClassLoader classLoader, Class<?> targetClass,
        ...
        CtField hf =
                CtField.make("private " + InvocationHandler.class.getName() + " handler;", proxy);
        proxy.addField(hf);

        CtConstructor constructor = new CtConstructor(
                new CtClass[] {pool.get(InvocationHandler.class.getName())}, proxy);
        ...
        for (Method method : arr) {
            ...
            sb.append(modifier(method.getModifiers())).append(' ').append(getParameterType(rt))
