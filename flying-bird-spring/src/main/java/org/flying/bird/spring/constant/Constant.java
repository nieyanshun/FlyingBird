package org.flying.bird.spring.constant;

public class Constant {

    /* Reference ATTR */

    public static final String REFERENCE_ATTR_CLAZZ = "class";

    public static final String REFERENCE_ATTR_RETRIES = "retries";
    ...
    /* Service ATTR */
    public static final String SERVICE_ATTR_INTERFACE = "interface";
