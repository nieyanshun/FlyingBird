/*
 * Copyright (c) 1999, 2008, Oracle and/or its affiliates. All rights reserved. DO NOT ALTER OR
...
public class ProxyGenerator {
    ...
    private void addProxyMethod(Method m, Class fromClass) {
        ...
        sigmethods
                .add(new ProxyMethod(name, parameterTypes, returnType, exceptionTypes, fromClass));
    }
        ...
        nextNewReturnType: for (ProxyMethod pm : methods) {
            ...
            if (newReturnType.isPrimitive()) {
                throw new IllegalArgumentException("methods with same signature "
                        ...
                        + " but incompatible return types: " + newReturnType.getName()
                        + " and others");
            }
            boolean added = false;
    ...
    private class ProxyMethod {
        ...
        private MethodInfo generateMethod() throws IOException {
            ...
            out.writeShort(cp.getFieldRef(dotToSlash(className), methodFieldName,
            ...
            if (catchList.size() > 0) {
                ...
                minfo.exceptionTable.add(new ExceptionTableEntry(tryBegin, tryEnd, pc,
                        cp.getClass("java/lang/Throwable")));
         ...
         */
        private void codeWrapArgument(Class type, int slot, DataOutputStream out)
                throws IOException {
            if (type.isPrimitive()) {
        ...
        private void codeUnwrapReturnValue(Class type, DataOutputStream out) throws IOException {
            if (type.isPrimitive()) {
                ...
                out.writeShort(cp.getMethodRef(prim.wrapperClassName, prim.unwrapMethodName,
                        prim.unwrapMethodDesc));
        ...
        /**
         * Generate code for initializing the static field that stores the Method object for this
         * proxy method. The code is written to the supplied stream.
         */
        private void codeFieldInitialization(DataOutputStream out) throws IOException {
            ...
            for (int i = 0; i < parameterTypes.length; i++) {
                ...
                if (parameterTypes[i].isPrimitive()) {
                    ...
                    out.writeByte(opc_getstatic);
                    out.writeShort(
                            cp.getFieldRef(prim.wrapperClassName, "TYPE", "Ljava/lang/Class;"));
    ...
    private MethodInfo generateConstructor() throws IOException {
        MethodInfo minfo =
                new MethodInfo("<init>", "(Ljava/lang/reflect/InvocationHandler;)V", ACC_PUBLIC);
    ...
    private MethodInfo generateStaticInitializer() throws IOException {
        ...
        out.writeByte(opc_invokevirtual);
        out.writeShort(
                cp.getMethodRef("java/lang/Throwable", "getMessage", "()Ljava/lang/String;"));

        out.writeByte(opc_invokespecial);
        out.writeShort(
                cp.getMethodRef("java/lang/NoSuchMethodError", "<init>", "(Ljava/lang/String;)V"));
        ...
        out.writeByte(opc_invokespecial);
        out.writeShort(cp.getMethodRef("java/lang/NoClassDefFoundError", "<init>",
                "(Ljava/lang/String;)V"));
     ...
     */
    private void codeLocalLoadStore(int lvar, int opcode, int opcode_0, DataOutputStream out)
            throws IOException {
    ...
    private static class ConstantPool {
        ...
        public short getInterfaceMethodRef(String className, String name, String descriptor) {
            ...
            short nameAndTypeIndex = getNameAndType(name, descriptor);
            return getIndirect(
                    new IndirectEntry(CONSTANT_INTERFACEMETHOD, classIndex, nameAndTypeIndex));
        }
